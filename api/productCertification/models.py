...
class productCertification(models.Model):
    ...
    TypeOfProduct  = models.CharField(max_length=10000, blank=True)
    Model = models.CharField(max_length=10000, blank=True)
    Brand = models.CharField(max_length=10000, blank=True)
    MarketingName = models.CharField(max_length=10000, blank=True)
